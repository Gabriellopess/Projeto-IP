...
void drawFantasma(Texture2D fantasma1, Texture2D fantasma2, Vector2 enemyPositionplat, float *temporaryplat){
    ...
    while (!WindowShouldClose())    // Detect window close button or ESC key
    {
        ...
        BeginDrawing();
            ...
            if(!(finish == 1)){
                ...
                drawFantasma(fantasma2, fantasma1, enemyPositionplat, &temporaryplat);
                temporaryplat = enemyPositionplat.x;

                drawFantasma(fantasma2, fantasma1, enemyPosition2plat, &temporary2plat);
                ...
                if(CheckCollisionCircleRec(enemyPositionplat, 7, playerRect)){
                    deathHero2(&player.position.x,&player.position.y,&enemyPositionplat.x,&enemyPositionplat.y,&enemyPosition2plat.x,&enemyPosition2plat.y,&lifes);
                }
